...
export class ItemService {
  ...
  updatedItemOrder(payload: IUpdateOrderItemPayload): Observable<Item> {
    return this.data.patch<Item, IUpdateOrderItemPayload>(
      this.urlService + `/change-order/${payload.id}`,
      payload
    );
  }
}
